...
import { agregarInformacionPersonal } from '../database/informacionPersonal';
...
export const AgregarInformacionPersonal = () => {
   ...
   console.log(e.target.files)
      ...
      const handleSubmit=async (e)=>{
        ...
        const resp=  await agregarInformacionPersonal(data)
